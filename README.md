...
tag `v0.16.5`; new releases do not create language-prefixed tags. The project
...
```bash
go get github.com/jim-technologies/invariantprotocol/go@v0.16.5
```
...
```bash
pip install "invariant-protocol @ git+https://github.com/jim-technologies/invariantprotocol.git@v0.16.5#subdirectory=python"

# Include the optional PyArrow bridge:
pip install "invariant-protocol[data] @ git+https://github.com/jim-technologies/invariantprotocol.git@v0.16.5#subdirectory=python"
```
...
```toml
[dependencies]
invariant-protocol = { git = "https://github.com/jim-technologies/invariantprotocol", tag = "v0.16.5" }

[build-dependencies]
invariant-protocol-codegen = { git = "https://github.com/jim-technologies/invariantprotocol", tag = "v0.16.5" }
```

TypeScript:

```bash
npm install --allow-git=root "github:jim-technologies/invariantprotocol#v0.16.5"
```
