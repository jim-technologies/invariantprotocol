...
class ChangeRecord(_message.Message):
    __slots__ = ("operation", "key", "before", "after", "data_collection", "schema_reference", "source_position", "transaction", "source_time", "capture_time", "changed_fields", "source_extension", "source_message")
    ...
    def __init__(self, operation: _Optional[_Union[Operation, str]] = ..., key: _Optional[_Union[Record, _Mapping]] = ..., before: _Optional[_Union[Record, _Mapping]] = ..., after: _Optional[_Union[Record, _Mapping]] = ..., data_collection: _Optional[_Union[DataCollection, _Mapping]] = ..., schema_reference: _Optional[_Union[SchemaReference, _Mapping]] = ..., source_position: _Optional[_Union[SourcePosition, _Mapping]] = ..., transaction: _Optional[_Union[TransactionContext, _Mapping]] = ..., source_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., capture_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., changed_fields: _Optional[_Union[ChangedFieldMask, _Mapping]] = ..., source_extension: _Optional[_Union[SourceExtension, _Mapping]] = ..., source_message: _Optional[_Union[Value, _Mapping]] = ...) -> None: ...
